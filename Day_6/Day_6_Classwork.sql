...
INSERT INTO `online_books`(`id`, `title`, `author`, `genre`, `price`, `copies_sold`) VALUES (1, 'The Silent Patient', 'Alex Michaelides', 'Thriller', 399.00, 1200),
(2, 'Atomic Habits', 'James Clear', 'Self-help', 499.00, 2000),
(3, 'The Psychology of Money', 'Morgan Housel', 'Finance', 350.00, 1800)
...
SELECT COUNT(*) FROM `online_books`
-- Show the title and author from books table with aliases Book Title and Written By.
SELECT `title`, `author` AS 'Book Title' , 'Written By' FROM `online_books` 